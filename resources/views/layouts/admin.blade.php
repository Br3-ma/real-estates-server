        ...
        ***********************************-->
        <div class="content-body">
			...
			<div class="container-fluid">
                <div class="mb-3 form-head d-md-flex mb-sm-4 align-items-start">
					<div class="mr-auto d-lg-block">
						<h2 class="text-black font-w600">Dashboard</h2>
						<p class="mb-0">Welcome to Omah Property Admin</p>
					</div>
					<a href="javascript:void(0);" class="mr-3 rounded btn btn-primary light">Refresh</a>
				...
				<div class="row">
					<div class="col-xl-6 col-xxl-12">
						<div class="row">
							<div class="col-xl-12">
								<div class="text-white card bg-danger property-bx">
									<div class="card-body">
										<div class="media d-sm-flex d-block align-items-center">
											<span class="mb-3 mr-4 d-block mb-sm-0">
											...
											<div class="mb-3 mr-5 media-body mb-sm-0">
												<h4 class="text-white fs-22">Total Properties</h4>
												<div class="mt-3 mb-2 progress" style="height:8px;">
													<div class="bg-white progress-bar progress-animated" style="width: 86%; height:8px;" role="progressbar">
									...
									<div class="card-body">
										<div class="media align-items-center">
											<div class="mr-3 media-body">
												<h2 class="text-black fs-36 font-w600">2,356</h2>
												<p class="mb-0 text-black fs-18 font-w500">Properties for Sale</p>
							...
							<div class="col-sm-12 col-md-6">
								<div class="card">
									<div class="card-body">
										<div class="media align-items-center">
											<div class="mr-3 media-body">
												<h2 class="text-black fs-36 font-w600">2,206</h2>
												<p class="mb-0 text-black fs-18 font-w500">Properties for Rent</p>
												<span class="fs-13">Target 3k/month</span>
											</div>
											<div class="d-inline-block position-relative donut-chart-sale">
					...
					<div class="col-xl-6 col-xxl-12">
						<div class="card">
							<div class="pb-0 border-0 card-header">
								<h3 class="text-black fs-20">Total Revenue</h3>
							...
							<div class="pt-2 pb-0 card-body">
								<div class="flex-wrap d-flex align-items-center">
									<span class="mr-3 text-black fs-36 font-w600">$678,345</span>
									<p class="mb-3 mr-3 mr-sm-auto mb-sm-0">last month $563,443</p>
									<div class="d-flex align-items-center">
										<svg class="mr-3" width="87" height="47" viewBox="0 0 87 47" fill="none" xmlns="../../../www.w3.org/2000/svg.html">
										...
										<span class="mr-2 fs-22 text-success">7%</span>
										<svg width="12" height="6" viewBox="0 0 12 6" fill="none" xmlns="../../../www.w3.org/2000/svg.html">
					...
					<div class="col-xl-9 col-xxl-8">
						<div class="row">
							<div class="col-xl-8 col-xxl-12">
								<div class="card">
									<div class="pb-0 border-0 card-header">
										<h3 class="text-black fs-20">Overview</h3>
										<div class="ml-auto dropdown">
											<div class="btn-link" data-toggle="dropdown" >
												<svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"></rect><circle fill="#000000" cx="5" cy="12" r="2"></circle><circle fill="#000000" cx="12" cy="12" r="2"></circle><circle fill="#000000" cx="19" cy="12" r="2"></circle></g></svg>
											</div>
									...
									<div class="card-body">
										<div class="flex-wrap d-sm-flex justify-content-around">
											<div class="mb-4 d-flex align-items-center">
												...
												<div>
													<p class="mb-1 fs-14">Total Sale</p>
													<span class="text-black fs-18 font-w700">2,346 Unit</span>
												</div>
											</div>
											<div class="mb-4 d-flex align-items-center">
												<span class="p-3 mr-3 rounded bg-success">
													<svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="../../../www.w3.org/2000/svg.html">
														<path d="M10.3458 25.7292H1.35412C0.758283 25.7292 0.270782 25.2417 0.270782 24.6458V9.69583C0.270782 9.42499 0.379116 9.09999 0.595783 8.93749L9.58745 0.541659C9.91245 0.270825 10.3458 0.162492 10.725 0.324992C11.1583 0.541659 11.375 0.920825 11.375 1.35416V24.7C11.375 25.2417 10.8875 25.7292 10.3458 25.7292ZM2.38328 23.6167H9.26245V3.79166L2.38328 10.1833V23.6167Z" fill="white"/>
														<path d="M24.6458 25.7292H10.2916C9.69578 25.7292 9.20828 25.2417 9.20828 24.6458V11.9167C9.20828 11.3208 9.69578 10.8333 10.2916 10.8333H24.6458C25.2416 10.8333 25.7291 11.3208 25.7291 11.9167V24.7C25.7291 25.2417 25.2416 25.7292 24.6458 25.7292ZM11.375 23.6167H23.6166V12.9458H11.375V23.6167Z" fill="white"/>
														<path d="M19.5541 25.7292H15.3833C14.7874 25.7292 14.2999 25.2417 14.2999 24.6458V18.0375C14.2999 17.4417 14.7874 16.9542 15.3833 16.9542H19.5541C20.1499 16.9542 20.6374 17.4417 20.6374 18.0375V24.6458C20.6374 25.2417 20.1499 25.7292 19.5541 25.7292ZM16.4666 23.6167H18.5249V19.1208H16.4666V23.6167Z" fill="white"/>
												...
												<div>
													<p class="mb-1 fs-14">Total Rent</p>
													<span class="text-black fs-18 font-w700">1,252 Unit</span>
												</div>
											</div>
										</div>
										<div id="chartBar"></div>
							...
							<div class="col-xl-4 col-xxl-12">
								<div class="row">
										...
										<div class="card">
											<div class="card-body">
												...
												<div class="flex-wrap mt-3 d-flex">
													<span class="mb-2 mr-5 text-black font-w600">
													<svg class="mr-2" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="../../../www.w3.org/2000/svg.html">
														<rect width="20" height="20" rx="8" fill="#FFB067"/>
													</svg>Agent</span>
													<span class="mb-2 text-black font-w600">
													<svg class="mr-2" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="../../../www.w3.org/2000/svg.html">
									...
									<div class="col-xl-12 col-xxl-6 col-md-6">
										<div class="card">
											<div class="card-body">
												<p class="mb-2 text-black d-flex fs-16 font-w500">Product Viewed
													<span class="ml-auto pull-right text-dark fs-14">561/days</span>
												</p>
												<div class="mb-4 progress" style="height:10px">
													<div class="progress-bar bg-primary progress-animated" style="width:75%; height:10px;" role="progressbar">
														<span class="sr-only">75% Complete</span>
													</div>
												</div>
												<p class="mb-2 text-black d-flex fs-16 font-w500">Product Listed
													<span class="ml-auto pull-right text-dark fs-14">3,456 Unit</span>
												</p>
							...
							<div class="col-xl-12">
								<div class="card">
									<div class="pb-0 border-0 card-header">
										<h3 class="text-black fs-20">Properties Map Location</h3>
										<div class="ml-auto dropdown">
											<div class="btn-link" data-toggle="dropdown" >
												<svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"></rect><circle fill="#000000" cx="5" cy="12" r="2"></circle><circle fill="#000000" cx="12" cy="12" r="2"></circle><circle fill="#000000" cx="19" cy="12" r="2"></circle></g></svg>
											</div>
									...
									<div class="card-body">
										<div class="row">
											<div class="col-lg-3">
												<p class="mb-2 text-black d-flex align-items-center fs-16 font-w500">Europe
													<span class="ml-2 pull-right text-dark fs-14">653 Unit</span>
												</p>
												<div class="mb-4 progress" style="height:10px">
													<div class="progress-bar bg-primary progress-animated" style="width:75%; height:10px;" role="progressbar">
														<span class="sr-only">75% Complete</span>
												...
												<p class="mb-2 text-black d-flex align-items-center fs-16 font-w500">Asia
													<span class="ml-2 pull-right text-dark fs-14">653 Unit</span>
												</p>
												<div class="mb-4 progress" style="height:10px">
												...
												<p class="mb-2 text-black d-flex align-items-center fs-16 font-w500">Africa
													<span class="ml-2 pull-right text-dark fs-14">653 Unit</span>
												</p>
												<div class="mb-4 progress" style="height:10px">
													<div class="progress-bar bg-primary progress-animated" style="width:75%; height:10px;" role="progressbar">
												...
												<p class="mb-2 text-black d-flex align-items-center fs-16 font-w500">Australia
													<span class="ml-2 pull-right text-dark fs-14">653 Unit</span>
												</p>
												<div class="mb-4 progress" style="height:10px">
												...
												<p class="mb-2 text-black d-flex align-items-center fs-16 font-w500">America
													<span class="ml-2 pull-right text-dark fs-14">653 Unit</span>
												</p>
												<div class="mb-4 progress" style="height:10px">
												...
												<p class="mb-2 text-black d-flex align-items-center fs-16 font-w500">USA
													<span class="ml-2 pull-right text-dark fs-14">653 Unit</span>
												</p>
												<div class="mb-4 progress" style="height:10px">
					...
					<div class="col-xl-3 col-xxl-4">
						<div class="row">
							<div class="col-xl-12 col-lg-6">
								<div class="card">
									<div class="pb-0 border-0 card-header">
										<h3 class="text-black fs-20">Customer Review</h3>
										<div class="ml-auto dropdown">
											<div class="btn-link" data-toggle="dropdown" >
												<svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"></rect><circle fill="#000000" cx="5" cy="12" r="2"></circle><circle fill="#000000" cx="12" cy="12" r="2"></circle><circle fill="#000000" cx="19" cy="12" r="2"></circle></g></svg>
											</div>
									...
									<div class="pb-0 card-body">
										<div class="pb-3 mb-3 border-bottom">
											<div class="flex-wrap mb-3 d-flex align-items-end">
												<img class="mr-3 rounded"  src="public/images/customers/1.jpg" width="58" alt="">
												<div>
													<h6 class="text-black fs-16 font-w600">John Doe</h6>
											...
											<p class="mb-0 fs-14">Friendly service
										...
										<div class="pb-3 mb-3 border-bottom">
											<div class="flex-wrap mb-3 d-flex align-items-end">
												<img class="mr-3 rounded"  src="public/images/customers/2.jpg" width="58" alt="">
												<div>
													<h6 class="text-black fs-16 font-w600">Amelia Tuner</h6>
													<div class="star-icons">
														<i class="las la-star"></i>
														<i class="las la-star"></i>
														<i class="las la-star"></i>
												...
												<span class="ml-auto fs-14">10h ago</span>
											</div>
											<p class="mb-0 fs-14">I viewed a number of properties with Just Property and found them to be professional, efficient, patient, courteous and helpful every time.
											</p>
										</div>
										<div class="pb-3">
											<div class="flex-wrap mb-3 d-flex align-items-end">
												<img class="mr-3 rounded"  src="public/images/customers/3.jpg" width="58" alt="">
												<div>
													<h6 class="text-black fs-16 font-w600">Jessica Humb</h6>
													<div class="star-icons">
														<i class="las la-star"></i>
														<i class="las la-star"></i>
														<i class="las la-star"></i>
												...
												<span class="ml-auto fs-14">2d ago</span>
											</div>
											<p class="mb-0 fs-14">Dealing with Syamsudin and Bakri was a joy. I got in touch with Just Property after seeing a couple of properties that caught my eye. Both Syamsudin and Bakri strive to deliver a professional service and surpassed my expectations - they were not only helpful but extremely approachable and not at all bumptious...
											</p>
										</div>
									</div>
									<div class="p-0 border-0 card-footer">
										<a href="review.html" class="rounded btn d-block btn-primary">See More Reviews</a>
									</div>
								</div>
							</div>
							<div class="col-xl-12 col-lg-6">
								<div class="card">
									<div class="pb-0 border-0 card-header">
										<h3 class="text-black fs-20">Recent Property</h3>
										<div class="ml-auto dropdown">
											<div class="btn-link" data-toggle="dropdown" >
												<svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"></rect><circle fill="#000000" cx="5" cy="12" r="2"></circle><circle fill="#000000" cx="12" cy="12" r="2"></circle><circle fill="#000000" cx="19" cy="12" r="2"></circle></g></svg>
											</div>
									...
									<div class="card-body">
										<div class="testimonial-one owl-carousel">
											<div class="items">
												<a href="property-details.html"><img  src="public/images/testimonial/1.png" alt="#" class="mb-3 rounded w-100 mw-100"></a>
												<h5 class="mb-0 fs-16 font-w600"><a href="property-details.html" class="text-black">98AB Alexander Court, London</a></h5>
												<span class="mb-4 fs-14 d-block">45 Connor St. London, 44523</span>
												<a href="javascript:void(0);" class="p-1 pl-2 pr-2 mr-3 text-black rounded bgl-primary font-w600">
												<svg class="mr-2" width="20" height="13" viewBox="0 0 20 13" fill="none" xmlns="../../../www.w3.org/2000/svg.html">
												...
												4</a>
												<a href="javascript:void(0);" class="p-1 pl-3 pr-3 text-black rounded bgl-primary font-w600">
												<svg class="mr-2" width="13" height="15" viewBox="0 0 13 15" fill="none" xmlns="../../../www.w3.org/2000/svg.html">
												...
												<p class="mt-3 mb-0 fs-14">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad mini</p>
											</div>
											<div class="items">
												<a href="property-details.html"><img  src="public/images/testimonial/1.png" alt="#" class="mb-3 rounded w-100 mw-100"></a>
												<h5 class="mb-0 fs-16 font-w600"><a href="property-details.html" class="text-black">98AB Alexander Court, London</a></h5>
