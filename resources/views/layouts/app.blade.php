...
<head>
    ...
    <title>SQuare | Administrator</title>
...
<body>
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="{{ url('/boost-plans') }}">Boost Plans</a></li>
                        </ul>
                    </li>
                    {{-- <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
				...
				<div class="copyright">
					<p><strong>Square Dashboard</strong> ©All Rights Reserved</p>
					<p>by Twalitso</p>
				</div>
			</div>
        </div>        <!--**********************************
        ...
        ***********************************-->
		...
		<div class="footer">
    <div class="copyright">
        <p>Copyright © Designed &amp; Developed by <a href="../../../Twalitso.com/index.html" target="_blank">Twalitso</a> 2020</p>
    </div>
</div>
        <!--**********************************
            Footer end
    ...
    ***********************************-->
	<script src="public/vendor/global/global.min.js" type="text/javascript"></script>
		...
		<!--		<script src="https://Square.dexignzone.com/laravel/demo/js/custom.min.js" type="text/javascript"></script>
			<script src="https://Square.dexignzone.com/laravel/demo/js/deznav-init.js" type="text/javascript"></script> -->
<!--
 	--></body>

<!-- Mirrored from Square.dexignzone.com/laravel/demo/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Oct 2024 12:43:39 GMT -->
</html>
